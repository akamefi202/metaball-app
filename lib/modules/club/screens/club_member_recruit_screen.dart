...
import 'package:metaball_app/modules/club/widgets/club_member_recruit_item.dart';
...
class ClubMemberRecruitScreen extends StatefulWidget {
  final String? clubId;

  const ClubMemberRecruitScreen({super.key, this.clubId});
  @override
  State<ClubMemberRecruitScreen> createState() =>
      _ClubMemberRecruitScreenState();
}

class _ClubMemberRecruitScreenState extends State<ClubMemberRecruitScreen> {
  @override
  void initState() {
    super.initState();
  }
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            ...
            context.push(RouteKey.clubMemberRecruitFilter.location);
          },
  ...
  Widget renderUserList(List<UserModel> userList) {
    ...
    for (UserModel e in userList) {
      userWidgets.add(ClubMemberRecruitItem(model: e));
    }
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(l10n.inviteLabel, style: ThemeFonts.of(context).heading3),
          centerTitle: true,
        ),
        body: Padding(

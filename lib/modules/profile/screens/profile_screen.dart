...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget renderProfileMenuItem() {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return InkWell(
          onTap: () {
            debugPrint("profile menu item is pressed");
          },
          child: Padding(
            ...
            child: Row(children: [
              ClipRRect(
                ...
                child: Image(
                    width: 56.0,
                    height: 56.0,
                    image: AssetImage(result.avatar == ''
  ...
  Widget renderNewsMenuItem() {
    ...
    return InkWell(
      onTap: () {
        debugPrint("news menu item is pressed");
      },
      child: Padding(
        padding: EdgeInsets.all(Spacing.extraSmallSpacing()),
        child: Row(children: [
        ...
        body: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("account information menu item is pressed");
              },
            ),
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("connection menu item is pressed");
              },
            ),
            CustomMenuItem(
              text: l10n.postLabel,
              ...
              onPressed: () {
                debugPrint("post menu item is pressed");
              },
            ),
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("clubs menu item is pressed");
              },
            ),
            SizedBox(height: Spacing.generate(4)),
            SizedBox(
            ...
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("customer service menu item is pressed");
              },
            ),
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("user guide menu item is pressed");
              },
            ),
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("user agreement menu item is pressed");
              },
            ),
            CustomMenuItem(
              ...
              onPressed: () {
                debugPrint("company information menu item is pressed");
              },
            ),
          ]),
        ),
